...
|---|---|---|---|---|---|---|
| ISS-101 | Agent Studio prototype | in progress | current | DevRev ISS-101; Slack design thread | Finish connector empty state | high |

### Signals
| Source | Signal | Related item | Freshness | Evidence | Action |
|---|---|---|---|---|---|
| Slack | Review request from design partner | ISS-101 | current | #agent-studio 2026-06-15 | Reply after prototype polish |
...
| Issue | Title | Part | Sprint | Notes |
|---|---|---|---|---|
| ISS-101 | Agent Studio connector polish | ENH-123 | Sprint 42 | active |
