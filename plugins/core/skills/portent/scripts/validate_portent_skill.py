...
SKILL_REQUIRED = [
    ...
    r"Capture by default",
    r"Context Hunger",
    r"Avoid tiny narrow notes",
...
REQUIRED_EVAL_IDS = {
    ...
    "correction-is-writeback-trigger",
    "avoid-narrow-note-sprawl",
...
def validate_evals() -> None:
    ...
    require_patterns(
        ...
        [
            ...
            r"concrete skip reason",
            r"one focused context question",
            r"tiny narrow notes",
            r"user corrections as writeback triggers",
            r"no update needed",
            r"judge-only",
