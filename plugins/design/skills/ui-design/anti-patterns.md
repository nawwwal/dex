...
| Bounce/elastic easing | `cubic-bezier` with values > 1, `easeInBounce`, `spring-bounce` | Use ease-out for entrances/exits. Full easing guidance → /motion/principles.md |
