...
description: "Use when writing code that calls the Gemini API — text generation, image generation, chat, multimodal, streaming, function calling, structured output, or migrating from generateContent API."
---
