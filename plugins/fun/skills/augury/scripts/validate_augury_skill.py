#!/usr/bin/env python3
"""Validate the augury fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'augury'
REQUIRED_STRINGS = ['apophenia on purpose', 'uniform', 'not divination']
REQUIRED_SCRIPTS = ['scripts/draw.py']
REQUIRED_FILES = []
