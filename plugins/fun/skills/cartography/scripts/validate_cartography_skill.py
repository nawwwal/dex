#!/usr/bin/env python3
"""Validate the cartography fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'cartography'
REQUIRED_STRINGS = ['unflattering', 'privacy contract', 'explicit request']
REQUIRED_SCRIPTS = []
REQUIRED_FILES = []
