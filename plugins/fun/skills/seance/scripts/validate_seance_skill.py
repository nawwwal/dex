#!/usr/bin/env python3
"""Validate the seance fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'seance'
REQUIRED_STRINGS = ['residence', 'reconstruction is not resurrection', 'privacy contract']
REQUIRED_SCRIPTS = []
REQUIRED_FILES = []
