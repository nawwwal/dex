#!/usr/bin/env python3
"""Validate the register fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'register'
REQUIRED_STRINGS = ['--image', '--feed', 'persona harness', 'facts are sacred']
REQUIRED_SCRIPTS = []
REQUIRED_FILES = ['references/scheduling.md']
