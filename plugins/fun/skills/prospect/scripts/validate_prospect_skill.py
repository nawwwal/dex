#!/usr/bin/env python3
"""Validate the prospect fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'prospect'
REQUIRED_STRINGS = ['junkyard', 'actually play', 'novel']
REQUIRED_SCRIPTS = []
REQUIRED_FILES = ['references/junkyard.md']
