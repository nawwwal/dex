#!/usr/bin/env python3
"""Validate the arena fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'arena'
REQUIRED_STRINGS = ['deterministic', 'emergent norms', 'fixed seed']
REQUIRED_SCRIPTS = ['scripts/arena.py']
REQUIRED_FILES = ['strategies.example.json']
