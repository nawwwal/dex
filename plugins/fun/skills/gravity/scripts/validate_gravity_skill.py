#!/usr/bin/env python3
"""Validate the gravity fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'gravity'
REQUIRED_STRINGS = ['attractor', 'fixed point', 'iteration harness']
REQUIRED_SCRIPTS = []
REQUIRED_FILES = ['references/iteration-harness.md']
