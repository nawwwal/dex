#!/usr/bin/env python3
"""Validate the clone fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'clone'
REQUIRED_STRINGS = ['privacy contract', 'two clones', 'explicit request']
REQUIRED_SCRIPTS = ['scripts/corpus.py']
REQUIRED_FILES = []
