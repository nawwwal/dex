#!/usr/bin/env python3
"""Validate the oracle fun skill: frontmatter, auto-invocation, references, scripts, and contract."""
...
NAME = 'oracle'
REQUIRED_STRINGS = ['horizon', 'the seam', 'hindsight']
REQUIRED_SCRIPTS = []
REQUIRED_FILES = ['references/persona-harness.md']
