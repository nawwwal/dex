...
- For animation timing, easing, and GPU rules — load /motion skill
...
- For micro-interaction animation patterns — load /motion/components.md
...
- For prefers-reduced-motion implementation — load /motion/performance.md
